...
<div id="container"><i>กรอกข้อมูลในฟอร์ม. เครื่องหมายดอกจัน(*) หมายถึงห้ามว่าง</i><br/><br>
    <form:form action="${pageContext.request.contextPath}/qfaq/saveupdate" modelAttribute="qfaq" method="POST">
    <form:hidden path="qfaq_id"/>

    <div class="txt_field">
        <p class="ct">คำถาม:**<form:input path="qfaq_name"/></p>
